...
const FICHES = {
  philippe: { description:'Ancien Premier ministre (2017-2022), maire du Havre. Fondateur du parti Horizons.', programme:'Réforme de l\'État, transition écologique, pacte productif, refonte de la fiscalité, sécurité.', soutenir:'https://www.edouardphilippe.fr', twitter:'https://twitter.com/edouardphilippe', website:'https://www.edouardphilippe.fr' },
  lepen: { description:'Présidente du Rassemblement National, députée du Pas-de-Calais.', programme:'Priorité nationale, sécurité, pouvoir d\'achat, remigration, référendum d\'initiative citoyenne.', soutenir:'https://www.rassemblementnational.fr', twitter:'https://twitter.com/MLP_officiel', website:'https://www.rassemblementnational.fr' },
  attal: { description:'Ancien Premier ministre (2024), ancien ministre de l\'Éducation.', programme:'Continuité macroniste, école de la confiance, écologie pragmatique, réindustrialisation.', soutenir:'https://gabrielattal.fr', twitter:'https://twitter.com/GabrielAttal', website:'https://gabrielattal.fr' },
  melenchon: { description:'Député de Marseille, fondateur de La France insoumise.', programme:'Programme "L\'Avenir en commun".', soutenir:'https://jlm2027.fr', twitter:'https://twitter.com/JLMelenchon', website:'https://lafranceinsoumise.fr' },
  retailleau: { description:'Sénateur de la Vendée, président des Républicains depuis 2025.', programme:'Sécurité, immigration, identité nationale, baisse des impôts, autorité de l\'État.', soutenir:'https://www.brunoretailleau.fr', twitter:'https://twitter.com/BrunoRetailleau', website:'https://www.lesrepublicains.fr' },
  bertrand: { description:'Président de la région Hauts-de-France. Fondateur du mouvement Nous France.', programme:'Réindustrialisation, sécurité, immigration, identité, pouvoir d\'achat.', soutenir:'https://xavierbertrand.fr', twitter:'https://twitter.com/xbertrand', website:'https://xavierbertrand.fr' },
  glucksmann: { description:'Député européen, cofondateur de Place publique.', programme:'Europe sociale, écologie, démocratie, antitotalitarisme.', soutenir:'https://raphaelglucksmann.fr', twitter:'https://twitter.com/RGlucksmann', website:'https://raphaelglucksmann.fr' },
  guedj: { description:'Député de l\'Essonne, figure du Parti socialiste.', programme:'Restauration de l\'État social, services publics, écologie, justice fiscale.', soutenir:'https://jeromeguedj.fr', twitter:'https://twitter.com/jeromeguedj', website:'https://jeromeguedj.fr' },
  dupontaignan: { description:'Ancien député de l\'Essonne, président de Debout la France.', programme:'Référendum d\'initiative citoyenne, souverainisme, immigration, sécurité.', soutenir:'https://www.debout-la-france.fr', twitter:'https://twitter.com/ndupontaignan', website:'https://www.debout-la-france.fr' },
  lisnard: { description:'Maire de Cannes depuis 2014. Fondateur du mouvement Nouvelle Énergie.', programme:'Sécurité, numérique, attractivité économique, transition écologique.', soutenir:'https://www.davidlisnard.fr', twitter:'https://twitter.com/DavidLisnard', website:'https://www.davidlisnard.fr' },
  batho: { description:'Ancienne ministre de l\'Écologie, présidente de Génération Écologie.', programme:'Transition écologique, démocratie, justice climatique.', soutenir:'https://www.generation-ecologie.fr', twitter:'https://twitter.com/DelphineBatho', website:'https://www.generation-ecologie.fr' },
  philippot: { description:'Fondateur des Patriotes après son départ du Front National.', programme:'Souverainisme, sortie de l\'UE, référendum, immigration.', soutenir:'https://lespatriotes.fr', twitter:'https://twitter.com/FlorianPhilippot', website:'https://lespatriotes.fr' },
  asselineau: { description:'Fondateur de l\'Union populaire républicaine (UPR).', programme:'Sortie de l\'UE, de l\'euro et de l\'OTAN. Démocratie directe.', soutenir:'https://www.upr.fr', twitter:'https://twitter.com/AsselineauF', website:'https://www.upr.fr' },
  arthaud: { description:'Porte-parole de Lutte ouvrière.', programme:'Lutte des classes, nationalisations, services publics.', soutenir:'https://www.lutte-ouvriere.fr', twitter:'', website:'https://www.lutte-ouvriere.fr' },
  roussel: { description:'Sénateur du Nord, secrétaire national du Parti communiste français.', programme:'Services publics, retraites, pouvoir d\'achat, écologie populaire, paix.', soutenir:'https://www.pcf.fr', twitter:'https://twitter.com/f_roussel', website:'https://www.pcf.fr' },
  tondelier: { description:'Maire d\'Hénin-Beaumont, secrétaire nationale des Écologistes (EÉLV).', programme:'Écologie, justice sociale, droits humains, démocratie.', soutenir:'https://www.eelv.fr', twitter:'https://twitter.com/marine_td', website:'https://www.eelv.fr' },
  cazeneuve: { description:'Ancien Premier ministre (2016-2017). Fondateur du parti La Convention.', programme:'Rénovation démocratique, justice sociale, écologie, laïcité.', soutenir:'https://bernardcazeneuve.fr', twitter:'', website:'https://bernardcazeneuve.fr' },
  faure: { description:'Député de Seine-et-Marne, ancien Premier secrétaire du Parti socialiste.', programme:'Restauration de l\'État social, écologie, justice, services publics.', soutenir:'https://olivierfaure.fr', twitter:'https://twitter.com/OlivierFaure', website:'https://olivierfaure.fr' },
  ruffin: { description:'Député de la Somme, fondateur du mouvement Debout !.', programme:'Salaires, services publics, écologie populaire, démocratie, retraites.', soutenir:'https://francoisruffin.fr', twitter:'https://twitter.com/F_Ruffin', website:'https://francoisruffin.fr' },
  wauquiez: { description:'Président de la région Auvergne-Rhône-Alpes.', programme:'Sécurité, immigration, identité, souveraineté, autorité.', soutenir:'https://www.laurentwauquiez.fr', twitter:'https://twitter.com/lwauquiez', website:'https://www.laurentwauquiez.fr' },
  devillepin: { description:'Ancien Premier ministre (2005-2007). Candidat pressenti.', programme:'Souveraineté, diplomatie, culture, refonte des institutions.', soutenir:'', twitter:'', website:'' },
  zemmour: { description:'Journaliste et essayiste. Fondateur de Reconquête.', programme:'Immigration, identité nationale, remigration, grande rénovation.', soutenir:'https://www.reconquete.fr', twitter:'https://twitter.com/ZemmourEric', website:'https://www.reconquete.fr' },
  bouamrane: { description:'Maire de Saint-Ouen (93). Fondateur de La France Humaine et Forte.', programme:'Services publics, sécurité, écologie, démocratie locale.', soutenir:'', twitter:'', website:'' },
  egger: { description:'Maître de conférences en science politique. Fondatrice de Solution démocratique.', programme:'Référendum d\'initiative citoyenne, démocratie directe.', soutenir:'', twitter:'', website:'' },
  mikolajczak: { description:'Fondateur du parti Équinoxe, classé à gauche.', programme:'Transition écologique et sociale, démocratie participative.', soutenir:'', twitter:'', website:'' },
  kazib: { description:'Cheminot et militant syndical. Porte-parole de Révolution permanente.', programme:'Lutte des classes, nationalisations, services publics.', soutenir:'https://revolutionpermanente.fr', twitter:'https://twitter.com/AnasseKazib', website:'https://revolutionpermanente.fr' },
  branco: { description:'Avocat et essayiste. Fondateur du mouvement Les Ruches.', programme:'Démocratie directe, écologie, justice sociale.', soutenir:'', twitter:'https://twitter.com/juan_branco', website:'' },
  brun: { description:'Député socialiste de l\'Eure.', programme:'Salaires, pouvoir d\'achat, services publics.', soutenir:'', twitter:'', website:'' },
  maurel: { description:'Député européen, fondateur de la Gauche républicaine et socialiste.', programme:'République sociale, services publics, laïcité.', soutenir:'', twitter:'https://twitter.com/emmanuelmaurel', website:'' },
  ...
  massard: { description:'Vice-présidente de l\'UDB (Union démocratique bretonne).', programme:'Fédéralisme, défense des langues régionales, autonomie bretonne.', soutenir:'', twitter:'', website:'https://www.udb.bzh' },
  ...
  lalanne: { description:'Chanteur et militant. Fondateur du mouvement France Libre.', programme:'Souveraineté, libertés, non-conformisme.', soutenir:'', twitter:'https://twitter.com/Francis_Lalanne', website:'' },
  ...
  durif: { description:'Candidat sans étiquette, dit « le Grand Monarque ».', programme:'Aucun programme vérifiable.', soutenir:'', twitter:'', website:'' },
  royal: { description:'Ancienne ministre, présidente de la région Poitou-Charentes (2004-2014).', programme:'Écologie, éducation, services publics, parité.', soutenir:'', twitter:'https://twitter.com/SRoyal', website:'' },
  jadot: { description:'Ancien député européen (EÉLV). Hors course après retrait.', programme:'Écologie, climat, justice sociale.', soutenir:'', twitter:'https://twitter.com/yjadot', website:'' },
  rousseau: { description:'Ancienne députée (EÉLV). Hors course après retrait.', programme:'Écologie, féminisme, justice sociale.', soutenir:'', twitter:'https://twitter.com/SandrineRousseau', website:'' },
  autain: { description:'Ancienne députée de Seine-Saint-Denis. Candidature retirée.', programme:'Écologie, féminisme, justice sociale.', soutenir:'', twitter:'https://twitter.com/c_autain', website:'' }
};
